...
const courses = [
  {
    name: "Cr 001- Criminal Law",
    assignment: "0 out of 3",
    quiz: "0 out of 3",
    forum: "0 out of 3",
    progress: 20,
  },
  {
    name: "Cr 002- Civil Law",
    assignment: "0 out of 3",
    quiz: "0 out of 3",
    forum: "0 out of 3",
    progress: 40,
...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-orange-normal">
        ...
        {stats.map((s, i) => (
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <span className="text-xl font-medium text-black-normal">
                {s.value}
              </span>
            </div>
            <div className="flex items-center justify-center rounded-full border border-orange-light bg-white-normal p-3.5">
              ...
              {i === 2 && (
                <UserMultiple size={20} className="text-orange-500" />
              )}
